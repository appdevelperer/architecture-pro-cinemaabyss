...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentInput : IEquatable<PaymentInput>
    {
        /// <summary>
        /// Идентификатор пользователя, совершающего платеж
        /// </summary>
        /// <value>Идентификатор пользователя, совершающего платеж</value>
        /* <example>1</example> */
        [Required]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PaymentInput)obj);
        }

        /// <summary>
        /// Returns true if PaymentInput instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentInput to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public static bool operator ==(PaymentInput left, PaymentInput right)
        {
